          ...
          <div class="thumbnail">
			<img src="img/Charla01.jpg" class="img-rounded img-thumbnail" style="height:290px">
              <div class="caption">
                ...
                <p><a href="/hospital/public/charlaembarazada" class="btn btn-primary btn-sm" title="Ver detalles">Ver detalles <span class="glyphicon glyphicon-chevron-right"></span></a></p>
            </div>
          </div>
        </div>
          ...
          <div class="thumbnail">
			<img src="img/congreso2014/congreso3small.jpg" class="img-rounded img-thumbnail">
              <div class="caption">
                ...
                <p><a href="/hospital/public/congreso" class="btn btn-primary" title="Ver detalles">Ver detalles <span class="glyphicon glyphicon-chevron-right"></span></a></p>
            </div>
          </div>
        </div>
          ...
          <div class="thumbnail">
			<img src="img/cintarosadaazulsmall.png" class="img-rounded img-thumbnail">
              <div class="caption">
                ...
                <p><a class="btn btn-primary" href="/hospital/public/cintarosada">Ver Detalles <span class="glyphicon glyphicon-chevron-right"></span></a></p>
            </div>
          </div>
        </div>
	</div>
