...
<html lang="es-ES">
  <head>
    ...
    <title>@yield('title', 'Hospital Chiriqu&iacute;')</title>
	  <link rel="shortcut icon" href='/hospital/public/imgs/hospital.ico' type="image/x-icon">    
    {{-- Bootstrap --}}
        ...
        <div class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="/hospital/public/">Hospital Chiriqu&iacute; S.A.</a>
            </div>
            <div class="navbar-collapse collapse overthrow">
              <ul class="nav navbar-nav navbar-right">              
                <li class="dropdown">
                  ...
                  <li><a href="/hospital/public/historia">Historia</a></li>
                  <li><a href="/hospital/public/junta">Junta Directiva</a></li>
                  <li><a href="/hospital/public/fundadores">Nuestros Fundadores</a></li>
                  <li><a href="/hospital/public/mision">Misi&oacute;n y Visi&oacute;n</a></li>
                  </ul>
                </li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                  <li><a href="/hospital/public/directorio">Directorio y Especialidades</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                  <li><a href="/hospital/public/enfermeria">Nuestras Enfermeras</a></li>           
                  <!--   <li class="divider"></li> -->
                  <!--   <li class="nav-header">Maternidad</li>  -->
                  <!--    <li><a href="#">Obstetricia</a></li> -->
                  <!--     <li><a href="#">Labor y Parto</a></li> -->
                  <li><a href="/hospital/public/neonatologia">Neonatolog&iacute;a</a></li>
           ...
           <!--   ESTA SECCION FUE REMOVIDA EL 20 DE MAYO POR VANESSA         
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                  <li><a href="/hospital/public/hospitalizacion">Habitaciones</a></li>
                  <li><a href="/hospital/public/admision">Admisi&oacute;n</a></li>
                  <li><a href="/hospital/public/seguros">Seguros Nacionales e Internacionales</a></li>
                  <li><a href="/hospital/public/registrobb">Registro de Nacimiento</a></li>
                  <!--   <li><a href="#">Turismo M&eacute;dico</a></li>  -->
                  <li class="divider"></li>
                  <li class="dropdown-header">Servicios Hospitalarios</li>
                  <li><a href="/hospital/public/hemodialisis">Hemodi&aacute;lisis</a></li> 
                  <li><a href="/hospital/public/cuidados">Cuidados Intensivos</a></li> 
                  <li><a href="/hospital/public/quirofano">Quir&oacute;fano</a></li>
                  <li><a href="/hospital/public/laboratorio">Laboratorio </a></li>
                  <li><a href="/hospital/public/rayosx">Radiolog&iacute;a</a></li> 
                  <li><a href="/hospital/public/urgencias">Urgencias</a></li>
                  <li><a href="/hospital/public/capilla">Capilla</a></li>
                  <li><a href="/hospital/public/farmacia">Farmacia</a></li> 
                  </ul>
                </li>
                ...
                <li class="dropdown">
                  ...
                  <li><a href="/hospital/public/compromiso">Eventos</a></li>
                  <li><a href="/hospital/public/cintarosada">Campa&ntilde;as de Salud</a></li>
                  </ul>
                </li>
